...
public class HierarchicalIndexTreeMatcher extends IndexTreeMatcher {
	String dualorconSumSlice ="";
	public HierarchicalIndexTreeMatcher(DiffMatcher diffMatcher, String dualOrconSumSlice) {
		this.diffMatcher = diffMatcher;
		this.dualorconSumSlice=dualOrconSumSlice;
	}
	...
	private void matchIndexTree(List<IndexTreeNode> treeBefore, List<IndexTreeNode> treeAfter,
		...
		for(IndexTreeNode nodeBefore: treeBefore){
			...
			IndexTreeNode matchedNodeAfter = findMostSimilarNode(nodeBefore, nodeAfterList, pairMap, this.dualorconSumSlice);
