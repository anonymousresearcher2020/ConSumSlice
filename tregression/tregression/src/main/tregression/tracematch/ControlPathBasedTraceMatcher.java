...
public class ControlPathBasedTraceMatcher{
	...
	public PairList matchTraceNodePair(Trace newTrace, Trace oldTrace, DiffMatcher matcher, String dualOrconSumSlice) {
		
		IndexTreeNode newRoot = initVirtualRootWrapper(newTrace);
		IndexTreeNode oldRoot = initVirtualRootWrapper(oldTrace);
		
		HierarchyGraphDiffer differ = new HierarchyGraphDiffer();
		differ.diff(newRoot, oldRoot, false, new HierarchicalIndexTreeMatcher(matcher, dualOrconSumSlice), -1);//debug with true?
